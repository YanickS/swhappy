...
import com.epsi.swhappy.security.AuthoritiesConstants;
import com.epsi.swhappy.service.MailService;
import com.epsi.swhappy.service.UserService;
import com.epsi.swhappy.web.rest.vm.ManagedUserVM;
import com.epsi.swhappy.web.rest.util.HeaderUtil;
import com.epsi.swhappy.web.rest.util.PaginationUtil;
...
public class UserResource {
    ...
    public ResponseEntity<ManagedUserVM> updateUser(@RequestBody ManagedUserVM managedUserVM) {
        ...
        userService.updateUser(managedUserVM.getId(), managedUserVM.getLogin(), managedUserVM.getFirstName(),
            ...
            managedUserVM.getLangKey(), managedUserVM.getAuthorities(), managedUserVM.getAge(), managedUserVM.getScore(), managedUserVM.getSexe(), managedUserVM.getEntreprise());
